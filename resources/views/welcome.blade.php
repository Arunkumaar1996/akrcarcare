    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 text-center text-lg-start">
          ...
          <p>We offer daily, monthly, and urgent car wash services to keep your car looking as good as new. From hand washes to detailing, we've got you covered!</p>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Keep your car spotless every day with our regular cleaning services. Perfect for busy schedules!</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Maintain your car's shine with our monthly service package. Great for regular upkeep.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Need a quick cleaning? Our urgent service guarantees fast and thorough cleaning when you need it the most.</p>
              <form action="{{url('selected-plan/3')}}" method="get">
                @csrf
              <button class="btn btn-explore me-3" id="select-palan-3" type="submit">select</button>
            </form>
            </div>
          </div>
        </div>
